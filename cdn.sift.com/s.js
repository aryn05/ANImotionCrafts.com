...
var Sift = Sift || function() {
    ...
    function M(b, g) {
        function j() {
            var v = (new Date).getTime(),
                h = !1;
            do
                if (m < b.length) window.SIFT_DEBUG && window.performance &&
                    window.performance.mark(b[m].toString().substring(0, 50)), b[m](), m += 1, window.SIFT_DEBUG && window.performance && b[m] && (window.performance.mark(b[m].toString().substring(0, 50)), window.performance.measure(b[m - 1].toString().substring(0, 50), b[m - 1].toString().substring(0, 50), b[m].toString().substring(0, 50)));
                else {
                    h = !0;
                    break
                }
    ...
    function N() {
        ...
        M([function() {
            ...
            a: {
                ...
                var a = b.indexOf(";", i);
                if (a == -1) a = b.length;b = P(b.substring(i + h.length, a))
            }
            if (!b || b.length < 15 || b === "undefined" || b === "null") {
                ...
                if (typeof b.getRandomValues === "function")
                    for (var h = "", i = ["8", "9",
                            "a", "b"
                        ], a = new Uint8Array(1), c = 0; c < 36; c = c + 1) {
                        ...
                        for (h = b = ""; b++ < 36; h = h + (b * 51 & 52 ? (b ^ 15 ? 8 ^ Math.random() * (b ^ 20 ? 16 : 4) : 4).toString(16) : "-"));
                b = h;
                i = b;
                a = new Date;
            ...
            for (var b = l.plugins, h = b ? b.length : 0, i = "", a = 0; a < h; a++) var c = b[a],
                i = i + (c.name + c.description + c.filename +
                    c.length);
            g.numPlugins_ = h;
            ...
            if (l) {
                ...
                if (("ontouchstart" in window || l.maxTouchPoints > 0 || l.msMaxTouchPoints > 0) && b !== "Windows Phone" && b !== "Android" && b !== "iOS" && b !== "Other") g.tamperedOS_ = true;
                else {
                    if (typeof h !== "undefined") {
                        ...
                        if ((h.indexOf("win") === -1 && h.indexOf("linux") === -1 && h.indexOf("mac") ===
                                -1) !== (b === "Other")) {
                            g.tamperedOS_ = true;
                            return
                        }
            ...
            if ((b === "Chrome" || b === "Safari" || b === "Opera") && h !== "20030107") g.tamperedBrowser_ = true;
            else {
                h = eval.toString().length;
                if (h === 37 && b !== "Safari" && b !== "Firefox" && b !== "Other") g.tamperedBrowser_ = true;
                else if (h === 39 && b !==
                    "Internet Explorer" && b !== "Other") g.tamperedBrowser_ = true;
                else if (h === 33 && b !== "Chrome" && b !== "Opera" && b !== "Other") g.tamperedBrowser_ = true;
                else {
                    var i;
                    try {
                        throw "a";
        ...
        var b =
            ...
            g = b.util = {
                ...
                wordsToBytes: function(b) {
                    for (var g = [], h = 0; h < 32 * b.length; h +=
                        8) g.push(b[h >>> 5] >>> 24 - h % 32 & 255);
                    return g
                },
                ...
                bytesToBase64: function(b) {
                    ...
                    for (var g = [], h = 0; h < b.length; h += 3)
                        for (var i = b[h] << 16 | b[h + 1] << 8 | b[h + 2], a = 0; 4 > a; a++) 8 * h + 6 * a <= 8 * b.length ? g.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(i >>>
                            6 * (3 - a) & 63)) : g.push("=");
                    return g.join("")
                },
    ...
    (function() {
        ...
        h._md5 =
            function(b) {
                ...
                a[c >>> 5] |= 128 << c % 32;
                a[(c + 64 >>> 9 << 4) + 14] = c;
                for (var c = h._ff, j = h._gg, o = h._hh, p = h._ii, k = 0; k < a.length; k += 16) var l = b,
                    U = d,
                    n = e,
                    q = f,
                    b = c(b, d, e, f, a[k + 0], 7, -680876936),
                    f = c(f, b, d, e, a[k + 1], 12, -389564586),
                    e = c(e, f, b, d, a[k + 2], 17, 606105819),
                    d = c(d, e, f, b, a[k + 3], 22, -1044525330),
                    b = c(b, d,
                        e, f, a[k + 4], 7, -176418897),
                    f = c(f, b, d, e, a[k + 5], 12, 1200080426),
                    e = c(e, f, b, d, a[k + 6], 17, -1473231341),
                    d = c(d, e, f, b, a[k + 7], 22, -45705983),
                    b = c(b, d, e, f, a[k + 8], 7, 1770035416),
                    f = c(f, b, d, e, a[k + 9], 12, -1958414417),
                    e = c(e, f, b, d, a[k + 10], 17, -42063),
                    d = c(d, e, f, b, a[k + 11], 22, -1990404162),
                    b = c(b, d, e, f, a[k + 12], 7, 1804603682),
                    f = c(f, b, d, e, a[k + 13], 12, -40341101),
                    e = c(e, f, b, d, a[k + 14], 17, -1502002290),
                    d = c(d, e, f, b, a[k + 15], 22, 1236535329),
                    b = j(b, d, e, f, a[k + 1], 5, -165796510),
                    f = j(f, b, d, e, a[k + 6], 9, -1069501632),
                    e = j(e, f, b, d, a[k + 11], 14, 643717713),
                    d = j(d, e, f, b, a[k + 0], 20, -373897302),
                    b = j(b, d, e, f, a[k + 5], 5, -701558691),
                    f = j(f, b, d, e, a[k + 10], 9, 38016083),
                    e = j(e, f, b, d, a[k + 15], 14, -660478335),
                    d = j(d, e, f, b, a[k + 4], 20, -405537848),
                    b = j(b, d, e, f, a[k + 9], 5, 568446438),
                    f = j(f, b, d, e, a[k + 14], 9, -1019803690),
                    e = j(e, f, b, d, a[k + 3], 14, -187363961),
                    d = j(d, e, f, b, a[k + 8], 20, 1163531501),
                    b = j(b, d, e, f, a[k + 13], 5, -1444681467),
                    f = j(f, b, d, e, a[k + 2], 9, -51403784),
                    e = j(e, f, b, d, a[k + 7], 14, 1735328473),
                    d = j(d, e, f, b, a[k + 12], 20, -1926607734),
                    b = o(b, d, e, f, a[k + 5], 4, -378558),
                    f = o(f, b, d, e, a[k + 8], 11, -2022574463),
                    e = o(e, f, b, d, a[k + 11], 16, 1839030562),
                    d = o(d, e, f, b, a[k + 14], 23, -35309556),
                    b = o(b, d, e, f, a[k + 1], 4, -1530992060),
                    f = o(f, b, d, e, a[k + 4], 11, 1272893353),
                    e = o(e, f, b, d, a[k + 7], 16, -155497632),
                    d = o(d, e, f, b, a[k + 10], 23, -1094730640),
                    b = o(b, d, e, f, a[k + 13], 4, 681279174),
                    f = o(f, b, d, e, a[k + 0], 11, -358537222),
                    e = o(e, f, b, d, a[k + 3], 16, -722521979),
                    d = o(d, e, f, b, a[k + 6], 23, 76029189),
                    b = o(b, d, e, f, a[k + 9], 4, -640364487),
                    f = o(f, b, d, e, a[k + 12], 11, -421815835),
                    e = o(e, f, b, d, a[k + 15], 16, 530742520),
                    d = o(d, e, f, b, a[k + 2], 23, -995338651),
                    b = p(b, d, e, f, a[k + 0], 6, -198630844),
                    f = p(f, b, d, e, a[k + 7], 10, 1126891415),
                    e = p(e, f, b, d, a[k + 14], 15, -1416354905),
                    d = p(d, e, f, b, a[k + 5], 21, -57434055),
                    b = p(b, d, e, f, a[k + 12], 6, 1700485571),
                    f = p(f, b, d, e, a[k + 3], 10, -1894986606),
                    e = p(e, f, b, d, a[k + 10], 15, -1051523),
                    d = p(d, e, f, b, a[k + 1], 21, -2054922799),
                    b = p(b, d, e, f, a[k + 8], 6, 1873313359),
                    f = p(f, b, d, e, a[k + 15], 10, -30611744),
                    e = p(e, f, b, d, a[k + 6], 15, -1560198380),
                    d = p(d, e, f, b, a[k + 13], 21, 1309151649),
                    b = p(b, d, e, f, a[k + 4], 6, -145523070),
                    f = p(f, b, d, e, a[k + 11], 10, -1120210379),
                    e = p(e, f, b, d, a[k + 2], 15, 718787259),
                    d = p(d, e, f, b, a[k + 9], 21, -343485551),
                    b = b + l >>> 0,
                    d = d + U >>> 0,
                    e = e + n >>> 0,
                    f = f + q >>> 0;
    ...
    (function() {
        var b = {
            ...
            splitNumRegx: /[\.\_,\-]/g,
            getNum: function(a, c) {
                var d = b.isStrNum(a) ? (c && b.isString(c) ? RegExp(c) : b.getNumRegx).exec(a) :
                    null;
                return d ? d[0] : null
            },
            ...
            formatNum: function(a, c) {
                ...
                for (d = 0; 4 > d; d++)
                    if (/^(0+)(.+)$/.test(e[d]) &&
                        (e[d] = RegExp.$2), d > c || !/\d/.test(e[d])) e[d] = "0";
            ...
            getPluginFileVersion: function(a, c, d, e) {
                ...
                for (e = 0; e < a.length; e++)
                    if (-1 < g && e > g && "0" != a[e] || d[e] != a[e] && (-1 == g && (g = e),
                            "0" != a[e])) return c;
                return f
            },
            AXO: function() {
            ...
            browser: {
                ...
                detectIE: function() {
                    ...
                    this.verIE = null;
                    this.isIE && (this.verIE = (b.isNum(a.documentMode) && 7 <= a.documentMode ? a.documentMode : 0) || (/^(?:.*?[^a-zA-Z])??(?:MSIE|rv\s*\:)\s*(\d+\.?\d*)/i.test(d) ?
            ...
            ev: {
                ...
                ifDetectDoneCallHndlrs: function() {
                    var a, c;
                    if (this.allDoneHndlrs.length && (!b.win || b.win.loaded && !b.win.loadPrvtHndlrs.length &&
            ...
            isMinVersion: function(a, c, d, e) {
                ...
                1 != f.getVersionDone && (f.getVersion(c, d, e), null === f.getVersionDone && (f.getVersionDone =
                    1));
            ...
            DOM: {
                isEnabled: {
                    ...
                    objectProperty: function(a) {
                        return a && a.tagName && b.browser.isIE ? /applet/i.test(a.tagName) ? !this.objectTag() || b.isDefined(b.pd.getPROP(document.createElement("object"), "object")) ?
                            1 : 0 : b.isDefined(b.pd.getPROP(document.createElement(a.tagName), "object")) ? 1 : 0 : 0
                    }
                },
                HTML: [],
                div: null,
                ...
                getStyle: {
                    ...
                    plugin: function(a) {
                        ...
                        return "background-color:transparent;background-image:none;vertical-align:baseline;outline-style:none;border-style:none;padding:0px;margin:0px;visibility:" +
                            (a ? "hidden;" : "visible;") + "display:inline;font-size:" + (c.pluginSize + 3) + "px;line-height:" + (c.pluginSize + 3) + "px;"
                    },
                ...
                insert: function(a, c, d, e, f, g, h) {
                    ...
                    if (b.isString(a) && /[^\s]/.test(a)) {
                        for (var a = a.toLowerCase().replace(/\s/g, ""), f = b.openTag + a + " ", f = f + ('style="' + this.getStyle.plugin(g) + '" '), j = 1, l = 1, g = 0; g < c.length; g += 2) /[^\s]/.test(c[g + 1]) && (f += c[g] + '="' + c[g + 1] + '" '), /width/i.test(c[g]) &&
                            (j = 0), /height/i.test(c[g]) && (l = 0);
                    ...
                    if (h && h.parentNode)
                        if (/iframe/i.test(h.tagName)) this.iframe.addHandler(h, [this.onLoadHdlr, a]), a.loaded = 0, a.spanId = b.name + "Span" + this.HTML.length, i = '<span id="' + a.spanId + '" style="' + this.getStyle.span(1) + '">' + f + "</span>", a.time = (new Date).getTime(), h = this.iframe.write(h, i), 0 <= h && (a.insertDomDelay = h);
                        else if (/div/i.test(h.tagName)) {
                        i = i.createElement("span");
                        this.setStyle(i, this.getStyle.span());
                        h.appendChild(i);
                        try {
                            a.time = (new Date).getTime(), i.innerHTML = f, a.insertDomDelay = (new Date).getTime() -
                                a.time
                        } catch (m) {}
                        a.spanObj = i
                    }
